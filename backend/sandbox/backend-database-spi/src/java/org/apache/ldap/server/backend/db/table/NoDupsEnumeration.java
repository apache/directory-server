...
/*
 * $Id: NoDupsEnumeration.java,v 1.4 2003/10/02 01:48:03 akarasulu Exp $
 *
 * -- (c) LDAPd Group                                                    --
    ...
    implements NamingEnumeration
{
    ...
    private final boolean m_doAscendingScan ;
     ...
     *
     * @param a_browser TODO
     * @param a_doAscendingScan TODO
     * @throws NamingException TODO
     */
    NoDupsEnumeration( TupleBrowser a_browser, boolean a_doAscendingScan )
        throws NamingException
    {
        m_browser = a_browser ;
        m_doAscendingScan = a_doAscendingScan ;
        prefetch() ;
    }
    ...
    {
        return m_doAscendingScan ;
    }


    /**
     * Prefetches a value into m_prefetched over writing whatever values were 
     * contained in the Tuple.
     *
     * @throws NamingException if the TupleBrowser m_browser could not advance
     */
        ...
        throws NamingException
    {
        ...
        if ( m_doAscendingScan ) 
        {
            l_isSuccess = m_browser.getNext( m_prefetched ) ;
        } 
        else 
        {
            l_isSuccess = m_browser.getPrevious( m_prefetched ) ;
        }

        m_hasNext = l_isSuccess ;
    }
}

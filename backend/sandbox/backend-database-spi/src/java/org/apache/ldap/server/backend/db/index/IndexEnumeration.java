...
/*
 * $Id: IndexEnumeration.java,v 1.4 2003/10/15 01:59:39 akarasulu Exp $
 *
 * -- (c) LDAPd Group                                                    --
    ...
    implements NamingEnumeration
{
    ...
    /** */
    private final boolean m_swapKeyVal ;
    /** */
     ...
     */
    IndexEnumeration( NamingEnumeration a_list ) throws NamingException
    {
        this( a_list, false, null ) ;
    }
     ...
     *
     * @param a_list TODO
     * @param a_swapKeyVal TODO
     * @throws NamingException TODO
     */
    IndexEnumeration( NamingEnumeration a_list, boolean a_swapKeyVal )
        throws NamingException
    {
        this( a_list, a_swapKeyVal, null ) ;
    }
     ...
     */
    IndexEnumeration( NamingEnumeration a_list, boolean a_swapKeyVal, 
        RE a_regex ) throws NamingException
    {
        m_re = a_regex ;
        m_underlying = a_list ;
        m_swapKeyVal = a_swapKeyVal ;
    ...
    private void prefetch() throws NamingException
    {
        ...
        {
            Tuple l_tuple = ( Tuple ) m_underlying.next() ;

            if ( m_swapKeyVal ) 
            {
                m_tmp.setSwapped( l_tuple, null ) ;
            } 
            else 
            {
                m_tmp.setTuple( l_tuple, null ) ;
            }

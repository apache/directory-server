...
/*
 * $Id: MasterTable.java,v 1.4 2003/09/18 23:04:29 akarasulu Exp $
 *
 * -- (c) LDAPd Group                                                    --
...
public interface MasterTable extends Table
{
     ...
     */
    Attributes get( BigInteger an_id ) throws NamingException ;
     ...
     */
    Attributes put( Attributes a_entry, BigInteger an_id )
     ...
     * @throws NamingException if there is a write error on the underlying Db
     */
    Attributes delete( BigInteger an_id )  throws NamingException ;
     ...
     */
    String getProperty( String a_property ) throws NamingException ;
     ...
     */
    void setProperty( String a_property, String a_value )
        throws NamingException ;
}
...
/*
 * $Id: OidRegistryImpl.java,v 1.4 2003/10/08 22:51:01 akarasulu Exp $
 *
 * -- (c) LDAPd Group                                                    --
...
/**
 * Simple OID registry component.
 * 
 * @phoenix:block
 * @phoenix:service name="org.apache.ldap.server.schema.OidRegistry"
 * @phoenix:mx-topic name="oid-registry"
 * 
 * @avalon.component name="oid-registry" lifestyle="singleton"
 * @avalon.service type="org.apache.ldap.server.schema.OidRegistry" version="1.0"
 * 
 * @author <a href="mailto:aok123@bellsouth.net">Alex Karasulu</a>
 * @author $Author: akarasulu $
 * @version $Revision: 1.4 $
 */
public class OidRegistryImpl implements OidRegistry
{ 
    ...
    {
        // If a_name is an OID than we return it.
        ...
        {
            return ( String ) m_byName.get( a_name ) ;
        }
         ...
         */
         ...
         throw new NamingException ( "OID for name '" + a_name + "' was not " 
    ...
    public String getPrimaryName( String a_oid ) throws NamingException
    {
        ...
        if ( null == l_value )
        {
            throw new NamingException ( "OID '" + a_oid 
        ...
        return ( String ) ( ( List ) l_value ).get( 0 ) ;
    }
    ...
    public List getNameSet( String a_oid ) throws NamingException
    {
        ...
        if ( l_value instanceof String )
        {
            return Collections.singletonList( l_value ) ;
        }

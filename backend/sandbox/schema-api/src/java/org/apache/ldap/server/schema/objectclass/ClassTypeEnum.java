...
/*
 * $Id: ClassTypeEnum.java,v 1.2 2003/09/30 01:02:37 akarasulu Exp $
 *
 * -- (c) LDAPd Group                                                    --
 ...
 */
public class ClassTypeEnum extends ValuedEnum
{
    ...
    public static final ClassTypeEnum ABSTRACT = 
        new ClassTypeEnum( "ABSTRACT", ABSTRACT_VAL ) ;
    
    /** ValuedEnum for auxillary objectClasses */
    public static final ClassTypeEnum AUXILLARY =
        new ClassTypeEnum( "AUXILLARY", AUXILLARY_VAL ) ;

    /** ValuedEnum for structural objectClasses */
    public static final ClassTypeEnum STRUCTURAL =
        new ClassTypeEnum( "STRUCTURAL", STRUCTURAL_VAL ) ;
     ...
     */
    private ClassTypeEnum( final String a_name, final int a_value )
    {
     ...
     */
    public static ClassTypeEnum getClassType( String a_name )
    {

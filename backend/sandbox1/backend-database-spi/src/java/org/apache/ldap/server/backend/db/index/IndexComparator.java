...
/*
 * $Id: IndexComparator.java,v 1.3 2003/09/16 05:29:52 akarasulu Exp $
 *
 * -- (c) LDAPd Group                                                    --
...
import org.apache.ldap.server.backend.db.table.TupleComparator ;
    ...
    implements TupleComparator
{
    ...
    private final boolean m_isForwardMap ;
    /** The key comparison to use */
    private final Comparator m_keyComp ;


    /**
     * Creates an IndexComparator.
     *
     * @param a_keyComp the table comparator to use for keys
     * @param a_isForwardMap whether or not the comparator should swap the 
     * key value pair while conducting comparisons.
     */
    public IndexComparator( Comparator a_keyComp, boolean a_isForwardMap )
    {
        m_keyComp = a_keyComp ;
        m_isForwardMap = a_isForwardMap ;
    }

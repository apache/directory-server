...
/*
 * $Id: SearchEngine.java,v 1.11 2003/10/15 01:59:39 akarasulu Exp $
 *
 * -- (c) LDAPd Group                                                    --
...
{
    /** Avalon service role */
    String ROLE = SearchEngine.class.getName() ;
     ...
     * @param a_env the environment for the search
     * @param a_filter the search filter AST root
     * @param a_reqCtls the search request controls
     * @param a_searchCtls the JNDI search controls
     ...
     * 
     * @param a_filter the filter root AST node
     * @param a_id the id of the entry to test
     ...
     */
    boolean evaluate( ExprNode a_filter, BigInteger a_id ) 

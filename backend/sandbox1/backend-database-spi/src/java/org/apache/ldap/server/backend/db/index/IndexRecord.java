...
/*
 * $Id: IndexRecord.java,v 1.5 2003/10/17 01:08:53 akarasulu Exp $
 *
 * -- (c) LDAPd Group                                                    --
...
public class IndexRecord
{
    ...
    private Attributes m_entry = null ;
     ...
     *
     * @param a_tuple the tuple for the IndexRecord
     * @param a_entry the resusitated entry if any
     */
    public void setTuple( Tuple a_tuple, Attributes a_entry )
    {
     ...
     * @param a_entry the resusitated entry if any
     */
    public void setSwapped( Tuple a_tuple, Attributes a_entry )
    {
     ...
     * Sets the entry id.
     *
     * @param a_id the id of the entry
     */
     ...
     * Sets the index key.
     *
     * @param a_key the key of the IndexRecord
     */
     ...
     * 
     * @param a_entry the entry's attributes
     */
    public void setAttributes( Attributes a_entry )
    {
        m_entry = a_entry ;
    }
     ...
     * IndexRecord.
     * 
     * @param a_record the record whose contents we copy
     */   
    public void copy( IndexRecord a_record )
    {
        m_entry = a_record.getAttributes() ;
        m_tuple.setKey( a_record.getIndexKey() ) ;
        m_tuple.setValue( a_record.getEntryId() ) ;
    }
}

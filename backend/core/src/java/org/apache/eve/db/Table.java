...
/*
 * $Id: Table.java,v 1.2 2003/09/06 02:51:37 akarasulu Exp $
 *
 * -- (c) LDAPd Group                                                    --
...
public interface Table
{
     ...
     */
    void setRenderer( TupleRenderer a_renderer ) ;
     ...
     */
    boolean has( Object a_key ) throws NamingException ;
     ...
     * @throws NamingException if there is a failure to read the underlying Db
     */
    boolean has( Object a_key, Object a_value ) throws NamingException ;
     ...
     * @param a_isGreaterThan boolean for greater than or less then comparison
     * @return true if a record with a key greater/less than the key argument
     * exists, false otherwise
     * @throws NamingException if there is a failure to read the underlying Db,
     * or if the underlying Db is not a Btree.
     */
    boolean has( Object a_key, boolean a_isGreaterThan ) 
     ...
     * duplicate values.
     */
    boolean has( Object a_key, Object a_val, boolean a_isGreaterThan )
        throws NamingException ;
     ...
     * @throws NamingException if there is a failure to read the underlying Db
     */
    Object get( Object a_key ) throws NamingException ;
     ...
     * the underlying Db
     */
    Object put( Object a_key, Object a_value ) throws NamingException ;
     ...
     * enumeration.
     *
     * @param a_key the key to use for the values
     * @param a_values the values supplied as an enumeration
     * @return TODO
     * @throws NamingException if something goes wrong
     */
    Object put( Object a_key, NamingEnumeration a_values ) 
        throws NamingException ;

    /**
     * Removes all records with a_key from this Table.
     *
     * @param a_key the key of the records to remove
     * @return TODO
     * @throws NamingException if there is a failure to read or write to
     * the underlying Db
     */
    Object remove( Object a_key ) throws NamingException ;

    /**
     * Removes a single specific record with a_key and a_value from this Table.
     *
     * @param a_key the key of the record to remove
     * @param a_value the value of the record to remove
     * @return TODO
     * @throws NamingException if there is a failure to read or write to
     * the underlying Db
     */
    Object remove( Object a_key, Object a_value )  throws NamingException ;


    /**
     * Removes a set of values with the same a_key from this Table.  If this 
     ...
     * the underlying Db
     */
    Object remove( Object a_key, NamingEnumeration a_values ) 
        throws NamingException ;
     ...
     */
    NamingEnumeration listValues( Object a_key ) 
        throws NamingException ;
     ...
     * @throws NamingException if the underlying cursor could not be set
     */
    NamingEnumeration listTuples( Object a_key ) throws NamingException ;
     ...
     * @param a_isGreaterThan if true the cursor iterates up over ascending keys
     ...
     * @throws NamingException if the underlying cursor could not be set
     */
    NamingEnumeration listTuples( Object a_key, boolean a_isGreaterThan )
        throws NamingException ;
     ...
     * @param a_isGreaterThan if true the cursor iterates up over ascending 
     * values greater than or equal to the a_val argument, but if false this 
     * cursor iterates down over descending values less than or equal to a_val 
     ...
     * duplicates enabled.
     */
    NamingEnumeration listTuples( Object a_key, Object a_val, 
     ...
     * @throws NamingException if there is a failure to read the underlying Db
     */
    int count( Object a_key ) throws NamingException ;
     ...
     *
     * @param a_key the Object key to count.
     * @param a_isGreaterThan boolean set to true to count for greater than and
     * equal to record keys, or false for less than or equal to keys.
     * @return the number of keys greater or less than a_key.
     * @throws NamingException if there is a failure to read the underlying Db
     */
    int count( Object a_key, boolean a_isGreaterThan ) throws NamingException ;

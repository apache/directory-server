...
/*
 * $Id: Tuple.java,v 1.4 2003/09/21 06:45:57 akarasulu Exp $
 *
 * -- (c) LDAPd Group                                                    --
...
public class Tuple
{
     ...
     * 
     * @param a_key the key to set
     * @param a_value the value to set
     */    
    public Tuple( Object a_key, Object a_value )
    {
        m_key = a_key ;
        m_value = a_value ;
    }
     ...
     *
     * @param a_key the new key to set
     */
     ...
     *
     * @param a_value the new value to set
     */

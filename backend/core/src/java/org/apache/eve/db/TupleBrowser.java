...
/*
 * $Id: TupleBrowser.java,v 1.2 2003/09/21 06:45:57 akarasulu Exp $
 *
 * -- (c) LDAPd Group                                                    --
...
public interface TupleBrowser
{
     ...
     * comparator.
     *
     * @param a_tuple the tuple to populate with a key/value pair
     * @return true if there was a next that was populated or false otherwise
     * @throws NamingException @todo
     */
    boolean getNext( Tuple a_tuple ) throws NamingException ;
     ...
     * @throws NamingException @todo
     */
    boolean getPrevious( Tuple a_tuple ) throws NamingException ;
}

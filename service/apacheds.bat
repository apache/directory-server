...
IF NOT exist target/apacheds-service-1.5.8-SNAPSHOT.jar GOTO :MVN
...
java %DEF_CTRLS% %EXT_CTRLS% %DEF_EXT_OP_REQ% %DEF_EXT_OP_RESP% -Dlog4j.configuration="file:///%cd%/target/instance/conf/log4j.properties" -jar target/apacheds-service-1.5.8-SNAPSHOT.jar %cd%/target/instance

...
IF NOT exist target/apacheds-service-2.0.0-M2.jar GOTO :MVN
...
java %DEF_CTRLS% %EXT_CTRLS% %DEF_EXT_OP_REQ% %DEF_EXT_OP_RESP% -Dlog4j.configuration="file:///%cd%/target/instance/conf/log4j.properties" -jar target/apacheds-service-2.0.0-M2.jar %cd%/target/instance

...
public class ChangePasswordServerFactory implements ManagedServiceFactory, Lifecycle
{
    ...
    private static final Logger log = LoggerFactory.getLogger( ChangePasswordServerFactory.class );
    ...
    public void updated( String pid, Dictionary config ) throws ConfigurationException
    {
        ...
        synchronized ( servers )
        {
            ...
            ChangePasswordServer changepwServer = (ChangePasswordServer) servers.get( pid );
    ...
    public void deleted( String pid )
    {
        synchronized ( servers )
        {
            ChangePasswordServer server = (ChangePasswordServer) servers.remove( pid );
    ...
    {
        return "Apache Change Password Service Factory";
    }
    ...
    public void deactivate()
    {
        synchronized ( servers )
        {
            ...
            while ( it.hasNext() )
            {
                ChangePasswordServer server = (ChangePasswordServer) it.next();
                server.destroy();
            }

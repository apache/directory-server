...
public class ScopeEnumerator implements Enumerator
{
     ...
     * @see org.apache.ldap.server.partition.store.impl.btree.Enumerator#enumerate(ExprNode)
     */
    ...
    class AssertDescendant implements IndexAssertion
    {
         ...
         * false otherwise.
         * 
         * @see org.apache.ldap.server.partition.store.impl.btree.IndexAssertion#assertCandidate(IndexRecord)
         */

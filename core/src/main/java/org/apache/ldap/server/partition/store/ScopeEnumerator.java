...
public class ScopeEnumerator implements Enumerator
{
     ...
     * @see org.apache.ldap.server.partition.store.Enumerator#enumerate(ExprNode)
     */
    ...
    class AssertDescendant implements IndexAssertion
    {
         ...
         * false otherwise.
         * 
         * @see org.apache.ldap.server.partition.store.IndexAssertion#assertCandidate(IndexRecord)
         */

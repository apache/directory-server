...
public class TimerInterceptor extends BaseInterceptor
{
    ...
    public void add( AddOperationContext addContext ) throws LdapException
    {
        ...
        if ( IS_DEBUG_STATS )
        {
            ...
            {
                long average = totalAdd.get() / ( nbAddCalls.get() * 1000L );
    ...
    public void bind( BindOperationContext bindContext ) throws LdapException
    {
        ...
        if ( IS_DEBUG_STATS )
        {
            ...
            {
                long average = totalBind.get() / ( nbBindCalls.get() * 1000L );
    ...
    public boolean compare( CompareOperationContext compareContext ) throws LdapException
    {
        ...
        if ( IS_DEBUG_STATS )
        {
            ...
            {
                long average = totalCompare.get() / ( nbCompareCalls.get() * 1000L );
    ...
    public void delete( DeleteOperationContext deleteContext ) throws LdapException
    {
        ...
        if ( IS_DEBUG_STATS )
        {
            ...
            {
                long average = totalDelete.get() / ( nbDeleteCalls.get() * 1000L );
    ...
    public Entry getRootDse( GetRootDseOperationContext getRootDseContext ) throws LdapException
    {
        ...
        if ( IS_DEBUG_STATS )
        {
            ...
            {
                long average = totalGetRootDse.get() / ( nbGetRootDseCalls.get() * 1000L );
    ...
    public boolean hasEntry( HasEntryOperationContext hasEntryContext ) throws LdapException
    {
        ...
        if ( IS_DEBUG_STATS )
        {
            ...
            {
                long average = totalHasEntry.get() / ( nbHasEntryCalls.get() * 1000L );
    ...
    public Entry lookup( LookupOperationContext lookupContext ) throws LdapException
    {
        ...
        if ( IS_DEBUG_STATS )
        {
            ...
            {
                long average = totalLookup.get() / ( nbLookupCalls.get() * 1000L );
    ...
    public void modify( ModifyOperationContext modifyContext ) throws LdapException
    {
        ...
        if ( IS_DEBUG_STATS )
        {
            ...
            {
                long average = totalModify.get() / ( nbModifyCalls.get() * 1000L );
    ...
    public void move( MoveOperationContext moveContext ) throws LdapException
    {
        ...
        if ( IS_DEBUG_STATS )
        {
            ...
            {
                long average = totalMove.get() / ( nbMoveCalls.get() * 1000L );
    ...
    public void moveAndRename( MoveAndRenameOperationContext moveAndRenameContext ) throws LdapException
    {
        ...
        if ( IS_DEBUG_STATS )
        {
            ...
            {
                long average = totalMoveAndRename.get() / ( nbMoveAndRenameCalls.get() * 1000L );
    ...
    public void rename( RenameOperationContext renameContext ) throws LdapException
    {
        ...
        if ( IS_DEBUG_STATS )
        {
            ...
            {
                long average = totalRename.get() / ( nbRenameCalls.get() * 1000L );
    ...
    public EntryFilteringCursor search( SearchOperationContext searchContext ) throws LdapException
    {
        ...
        if ( IS_DEBUG_STATS )
        {
            ...
            {
                long average = totalSearch.get() / ( nbSearchCalls.get() * 1000L );
    ...
    public void unbind( UnbindOperationContext unbindContext ) throws LdapException
    {
        ...
        if ( IS_DEBUG_STATS )
        {
            ...
            {
                long average = totalUnbind.get() / ( nbUnbindCalls.get() * 1000L );

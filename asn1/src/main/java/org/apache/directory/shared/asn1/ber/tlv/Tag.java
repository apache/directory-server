...
public class Tag implements Cloneable, Serializable
{
    ...
    public static final int[] TYPE_CLASS =
        { Tag.TYPE_CLASS_UNIVERSAL, Tag.TYPE_CLASS_APPLICATION, Tag.TYPE_CLASS_CONTEXT_SPECIFIC, Tag.TYPE_CLASS_PRIVATE };
    ...
    /**
     * The bytes read from the PDU. We store only 5 bytes, so we can't have tag
     * that are above 2^28
     */
    private byte[] tagBytes = new byte[]
        { 0, 0, 0, 0, 0 };
     ...
     *             Thrown if we have a cloning problem
     */

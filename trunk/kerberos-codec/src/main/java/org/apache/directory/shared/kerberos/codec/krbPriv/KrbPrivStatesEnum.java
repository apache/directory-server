...
/**
 * This class stores the KRB-PRIV grammar's constants. It is also used for debugging
 * purpose
 *
...
public enum KrbPrivStatesEnum implements States
{
     ...
     * @return The grammar name
     */
    public String getGrammarName( Grammar<KrbPrivContainer> grammar )
    {
    ...
    {
        return ( ( state == LAST_KRB_PRIV_STATE.ordinal() ) ? "LAST_KRB_PRIV_STATE" : name() );
    }
    ...
    {
        return this == LAST_KRB_PRIV_STATE;
    }

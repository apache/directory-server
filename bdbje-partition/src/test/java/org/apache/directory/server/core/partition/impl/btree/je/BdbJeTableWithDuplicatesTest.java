...
/**
 * Tests BdbJeTable operations with duplicates.  Does not test Cursor capabilities.
 *
 * @author <a href="mailto:dev@directory.apache.org">Apache Directory Project</a>
 */
public class BdbJeTableWithDuplicatesTest
{
    private static final Logger LOG = LoggerFactory.getLogger( BdbJeTableWithDuplicatesTest.class );
    ...
    BdbJeTable<String, String> table;
    static File dbDir;
    ...
    public static void init() throws Exception
    {
        ...
        dbDir = new File( workingDirectory + "/" + BdbJeTableWithDuplicatesTest.class.getSimpleName() );
        if ( dbDir.exists() )
        {
        ...
        dbDir.mkdirs();
        env = new BdbJePartitionEnviroment( schemaManager, new File( workingDirectory ) );
    }
    ...
    private BdbJeTable<String, String> _createTable()
    {
        ...
        Database db = env.createDb( "test", true );
        return new BdbJeTable<String, String>( db, schemaManager, comparator, comparator, serializer, serializer );
    }
    ...
    public void testNullKeyComparator() throws Exception
    {
        ...
        Database db = env.createDb( "testNullKeyComparator", true );
        new BdbJeTable<String, String>( db, schemaManager, null, comparator, null, new StringSerializer() );
    }
    ...
    public void testNullValueComparator() throws Exception
    {
        ...
        Database db = env.createDb( "testNullValueComparator", true );
        new BdbJeTable<String, String>( db, schemaManager, null, comparator, null, new StringSerializer() );
    }
    ...
    public void testHas() throws Exception
    {
        ...
        Cursor<Tuple<String, String>> cursor = table.cursor( partitionTxn );

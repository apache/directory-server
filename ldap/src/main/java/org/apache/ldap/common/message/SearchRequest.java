...
public interface SearchRequest extends ManyReplyRequest, AbandonableRequest
{
     ...
     * of responses.  It is at most required to return a done response when it
     * is complete however before then it can return search entry, search
    ...
    {
        SearchResponseDone.TYPE,
        SearchResponseEntry.TYPE,
        SearchResponseReference.TYPE,
     ...
     *
     * @param a_baseDn the search base
     */

...
public interface Assertion
{
     ...
     * 
     * @param a_dn the normalized dn of the candidate entry to be tested
     * @param a_entry the entry's attributes if available
     ...
     */
    boolean assertCandidate( String a_dn, Attributes a_entry )

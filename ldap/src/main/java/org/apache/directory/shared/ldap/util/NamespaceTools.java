...
public class NamespaceTools
{
     ...
     *
     * @param a_dn distinguished name to test.
     * @return true if it has only one component, false otherwise.
     * @throws InvalidNameException if a_dn is not syntactically correctly 
     */
    public static boolean isRoot( String a_dn )
    ...
    /**
     * Given a child distinguished name this method gets the distinguished
     * name of the parent.  If the child is only composed of one component
     * then null is returned.
     *
     * @param a_childDN the distinguished name of the child.
     * @return the parent's distinguished name, or null if the child is a root.
     * @throws InvalidNameException if dn is not syntactically correctly 
     */
    public static String getParent( String a_childDN )
        throws InvalidNameException
    {
        int l_index = -1 ;
    ...
    */
     ...
     * 
     * @param a_name the Name object to convert to a string.
     * @return the name as a string.
     * @throws InvalidNameException if the name is a federated composite name.
     */
    public static String getNamespaceString( Name a_name )
        throws InvalidNameException
    {
        if ( a_name instanceof CompositeName ) 
        {
     ...
     *
     * @param a_base the prefix of the name.
     * @param a_name the name to add to the prefix.
     * @return the name as a string off of a base.
     * @throws InvalidNameException if the name is a federated composite name
     * or if a_base is an invalid DN.
     */
    public static String getNamespaceString( String a_base, Name a_name )
        throws InvalidNameException
    {
        if ( a_name instanceof CompositeName ) 
        {
     ...
     *
     * @param a_name the name from which the last component is to be extracted.
     ...
     *
     * @param a_name the distinguished name or a name fragment
     * @return the rdn
     * TODO the name rdn is misused rename refactor this method
     */
     ...
     *
     * @param a_name the distinguished name to append the rdn to
     * @param a_rdn the relative distinguished name to append
     * @return the appended dn with the extra rdn added
     * TODO the name rdn is misused rename refactor this method
     */
     ...
     *
     * @param a_rdn the name component
     ...
     *
     * @param a_rdn the name component to get the value from
     ...
     * 
     * @param a_name1 the first name
     * @param a_name2 the second name
     ...
     * 
     * @param a_ancestor the base ancestor
     * @param a_descendant the candidate to test for descendancy

...
/**
 * This class implements the SearchRequest LDAP message. All the actions are
...
public class SearchRequestGrammar extends AbstractGrammar implements IGrammar
{
    ...
    private SearchRequestGrammar()
    {
        ...
        super.transitions[LdapStatesEnum.SEARCH_REQUEST_VALUE][LdapConstants.SEARCH_REQUEST_TAG] = new GrammarTransition(
            LdapStatesEnum.SEARCH_REQUEST_VALUE, LdapStatesEnum.SEARCH_REQUEST_BASE_OBJECT_TAG, new GrammarAction(
                "Init SearchRequest" )
            {
        ...
        super.transitions[LdapStatesEnum.SEARCH_REQUEST_BASE_OBJECT_TAG][UniversalTag.OCTET_STRING_TAG] = new GrammarTransition(
            LdapStatesEnum.SEARCH_REQUEST_BASE_OBJECT_TAG, LdapStatesEnum.SEARCH_REQUEST_BASE_OBJECT_VALUE, null );

        // SearchRequest ::= [APPLICATION 3] SEQUENCE {
        // baseObject LDAPDN, (Value)
        // ...
        // We have a value for the base object, we will store it in the message
        super.transitions[LdapStatesEnum.SEARCH_REQUEST_BASE_OBJECT_VALUE][UniversalTag.OCTET_STRING_TAG] = new GrammarTransition(
            LdapStatesEnum.SEARCH_REQUEST_BASE_OBJECT_VALUE, LdapStatesEnum.SEARCH_REQUEST_SCOPE_TAG,
        ...
        super.transitions[LdapStatesEnum.SEARCH_REQUEST_SCOPE_TAG][UniversalTag.ENUMERATED_TAG] = new GrammarTransition(
            LdapStatesEnum.SEARCH_REQUEST_SCOPE_TAG, LdapStatesEnum.SEARCH_REQUEST_SCOPE_VALUE, null );
        ...
        super.transitions[LdapStatesEnum.SEARCH_REQUEST_SCOPE_VALUE][UniversalTag.ENUMERATED_TAG] = new GrammarTransition(
            LdapStatesEnum.SEARCH_REQUEST_SCOPE_VALUE, LdapStatesEnum.SEARCH_REQUEST_DEREF_ALIASES_TAG,
        ...
        super.transitions[LdapStatesEnum.SEARCH_REQUEST_DEREF_ALIASES_TAG][UniversalTag.ENUMERATED_TAG] = new GrammarTransition(
            LdapStatesEnum.SEARCH_REQUEST_DEREF_ALIASES_TAG, LdapStatesEnum.SEARCH_REQUEST_DEREF_ALIASES_VALUE, null );
        ...
        super.transitions[LdapStatesEnum.SEARCH_REQUEST_DEREF_ALIASES_VALUE][UniversalTag.ENUMERATED_TAG] = new GrammarTransition(
            LdapStatesEnum.SEARCH_REQUEST_DEREF_ALIASES_VALUE, LdapStatesEnum.SEARCH_REQUEST_SIZE_LIMIT_TAG,
        ...
        super.transitions[LdapStatesEnum.SEARCH_REQUEST_SIZE_LIMIT_TAG][UniversalTag.INTEGER_TAG] = new GrammarTransition(
            LdapStatesEnum.SEARCH_REQUEST_SIZE_LIMIT_TAG, LdapStatesEnum.SEARCH_REQUEST_SIZE_LIMIT_VALUE, null );
        ...
        super.transitions[LdapStatesEnum.SEARCH_REQUEST_SIZE_LIMIT_VALUE][UniversalTag.INTEGER_TAG] = new GrammarTransition(
            LdapStatesEnum.SEARCH_REQUEST_SIZE_LIMIT_VALUE, LdapStatesEnum.SEARCH_REQUEST_TIME_LIMIT_TAG,
        ...
        super.transitions[LdapStatesEnum.SEARCH_REQUEST_TIME_LIMIT_TAG][UniversalTag.INTEGER_TAG] = new GrammarTransition(
            LdapStatesEnum.SEARCH_REQUEST_TIME_LIMIT_TAG, LdapStatesEnum.SEARCH_REQUEST_TIME_LIMIT_VALUE, null );
        ...
        super.transitions[LdapStatesEnum.SEARCH_REQUEST_TIME_LIMIT_VALUE][UniversalTag.INTEGER_TAG] = new GrammarTransition(
            LdapStatesEnum.SEARCH_REQUEST_TIME_LIMIT_VALUE, LdapStatesEnum.SEARCH_REQUEST_TYPES_ONLY_TAG,
        ...
        super.transitions[LdapStatesEnum.SEARCH_REQUEST_TYPES_ONLY_TAG][UniversalTag.BOOLEAN_TAG] = new GrammarTransition(
            LdapStatesEnum.SEARCH_REQUEST_TYPES_ONLY_TAG, LdapStatesEnum.SEARCH_REQUEST_TYPES_ONLY_VALUE, null );
        ...
        // The next transition will deal with the Filter. As a filter could
        // contains
        // sub-filter, we will initialize the filter Object right here.
        super.transitions[LdapStatesEnum.SEARCH_REQUEST_TYPES_ONLY_VALUE][UniversalTag.BOOLEAN_TAG] = new GrammarTransition(
            LdapStatesEnum.SEARCH_REQUEST_TYPES_ONLY_VALUE, LdapStatesEnum.SEARCH_REQUEST_FILTER, new GrammarAction(
                "store typesOnly value" )
            {
                public void action( IAsn1Container container ) throws DecoderException
                {
        ...
        super.transitions[LdapStatesEnum.SEARCH_REQUEST_FILTER][LdapConstants.AND_FILTER_TAG] = new GrammarTransition(
            LdapStatesEnum.SEARCH_REQUEST_FILTER, LdapStatesEnum.FILTER_GRAMMAR_SWITCH, null );
        ...
        super.transitions[LdapStatesEnum.SEARCH_REQUEST_FILTER][UniversalTag.SEQUENCE_TAG] = new GrammarTransition(
            LdapStatesEnum.SEARCH_REQUEST_FILTER, LdapStatesEnum.SEARCH_REQUEST_ATTRIBUTE_DESCRIPTION_LIST_VALUE, null );
        ...
        // (Length)
        // ...
        // We have to create an array of elements to store the list of
        // attributes
        ...
        super.transitions[LdapStatesEnum.SEARCH_REQUEST_ATTRIBUTE_DESCRIPTION_LIST_VALUE][UniversalTag.SEQUENCE_TAG] = new GrammarTransition(
            LdapStatesEnum.SEARCH_REQUEST_ATTRIBUTE_DESCRIPTION_LIST_VALUE,
            LdapStatesEnum.SEARCH_REQUEST_ATTRIBUTE_DESCRIPTION_TAG, new GrammarAction(
                "store Attribute Description List value" )
            {
                public void action( IAsn1Container container )
                {
        ...
        super.transitions[LdapStatesEnum.SEARCH_REQUEST_ATTRIBUTE_DESCRIPTION_TAG][UniversalTag.OCTET_STRING_TAG] = new GrammarTransition(
            ...
            LdapStatesEnum.SEARCH_REQUEST_ATTRIBUTE_DESCRIPTION_VALUE, null );

        // AttributeDescription ::= LDAPString (Value)
        // Decodes the attribute description and stores it.
        super.transitions[LdapStatesEnum.SEARCH_REQUEST_ATTRIBUTE_DESCRIPTION_VALUE][UniversalTag.OCTET_STRING_TAG] = new GrammarTransition(
            LdapStatesEnum.SEARCH_REQUEST_ATTRIBUTE_DESCRIPTION_VALUE,
            LdapStatesEnum.SEARCH_REQUEST_ATTRIBUTE_DESCRIPTION_TAG, new GrammarAction(
                "store Attribute Description value" )
            {
                public void action( IAsn1Container container ) throws DecoderException
                {
                    LdapMessageContainer ldapMessageContainer = ( LdapMessageContainer ) container;
                    ...
                    {
                        log.error( "Cannot decode the attribute description : {}", StringTools.dumpBytes( tlv
                            .getValue().getData() ) );

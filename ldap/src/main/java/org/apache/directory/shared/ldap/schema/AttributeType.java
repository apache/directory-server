 ...
 * @see <a href="http://www.ietf.org/internet-drafts/draft-ietf-ldapbis-models-11.txt">
 *     ldapbis [MODELS]</a>
...
public interface AttributeType extends SchemaObject
{
     ...
     * @throws NamingException if there is a failure to resolve the superior
     */
     ...
     * @throws NamingException if there is a failure to resolve the syntax
     */

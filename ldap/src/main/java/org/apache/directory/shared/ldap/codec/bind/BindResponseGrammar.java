...
/**
 * This class implements the BindResponse LDAP message. All the actions are
...
public class BindResponseGrammar extends AbstractGrammar implements IGrammar
{
    ...
    private BindResponseGrammar()
    {
        ...
        super.transitions[LdapStatesEnum.BIND_RESPONSE_VALUE][LdapConstants.BIND_RESPONSE_TAG] = new GrammarTransition(
            LdapStatesEnum.BIND_RESPONSE_VALUE, LdapStatesEnum.BIND_RESPONSE_LDAP_RESULT, new GrammarAction(
                "Init BindReponse" )
            {
        ...
        super.transitions[LdapStatesEnum.BIND_RESPONSE_LDAP_RESULT][UniversalTag.ENUMERATED_TAG] = new GrammarTransition(
            LdapStatesEnum.BIND_RESPONSE_LDAP_RESULT, LdapStatesEnum.LDAP_RESULT_GRAMMAR_SWITCH, new GrammarAction(
                "Allow pop" )
            {
        ...
        // If there is a sasl credential, we will decode it here. We must
        // control that we had a LdapResult
        //
        super.transitions[LdapStatesEnum.BIND_RESPONSE_LDAP_RESULT][LdapConstants.SERVER_SASL_CREDENTIAL_TAG] = new GrammarTransition(
            LdapStatesEnum.BIND_RESPONSE_LDAP_RESULT, LdapStatesEnum.BIND_RESPONSE_SERVER_SASL_CREDS_VALUE, null );
        ...
        super.transitions[LdapStatesEnum.BIND_RESPONSE_SERVER_SASL_CREDS_TAG][LdapConstants.SERVER_SASL_CREDENTIAL_TAG] = new GrammarTransition(
            LdapStatesEnum.BIND_RESPONSE_SERVER_SASL_CREDS_TAG, LdapStatesEnum.BIND_RESPONSE_SERVER_SASL_CREDS_VALUE,
            null );
        ...
        super.transitions[LdapStatesEnum.BIND_RESPONSE_SERVER_SASL_CREDS_VALUE][LdapConstants.SERVER_SASL_CREDENTIAL_TAG] = new GrammarTransition(
            LdapStatesEnum.BIND_RESPONSE_SERVER_SASL_CREDS_VALUE, LdapStatesEnum.GRAMMAR_END, new GrammarAction(
                "Store server sasl credentials value" )
            {
                public void action( IAsn1Container container )
                {

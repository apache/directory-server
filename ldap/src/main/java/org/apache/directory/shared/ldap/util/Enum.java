 ...
 * <code>==</code>. The equals() method will try == first so in most cases
 ...
 * may add additional Enum constants <em>of the type of the superclass</em>.
 * The query methods on the subclass will return all of the Enum constants from
...
public abstract class Enum implements Comparable, Serializable
{
     ...
     *         <code>Color[Red]</code>. Note that the package name is

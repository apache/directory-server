...
public class LdifIterator implements Iterator
{
     ...
     * @throws IOException
     *             if we cannot wrap the stream with a reader
     */
     ...
     * @throws IOException
     *             if we cannot wrap the reader with a bufferd reader
     */
    ...
    /**
     * If debugging is enabled these log messages are sent to either the console
     * or to the monitor if one is available.
     * 
     * @param msg
     ...
     * 
     * @throws IOException
     *             if it cannot read from the input channel
     */
     ...
     * 
     * @param line
     *            the line to filter comments out of

...
public class SchemaUtils
{
     ...
     *
     * @param ocs the objectClasses to list
     ...
     *
     * @param buf the string buffer to render the list of objectClasses into
     * @param ocs the objectClasses to list
     * @return a buffer which contains the rendered list
     */
     ...
     * objectClasses using the ( oid $ oid ) format.
     *
     * @param ats the attributeTypes to list
     * @return a buffer which contains the rendered list
     */
     ...
     * objectClasses using the ( oid $ oid ) format into an existing buffer.
     *
     * @param buf the string buffer to render the list of attributeTypes into
     * @param ats the attributeTypes to list
     * @return a buffer which contains the rendered list
     */
     ...
     * described in detail within section 4.1.1. of LDAPBIS
     * [<a href="http://ietf.org/internet-drafts/draft-ietf-ldapbis-models-12.txt">MODELS</a>]
     ...
     * syntax is described in detail within section 4.1.2. of LDAPBIS
     * [<a href="http://ietf.org/internet-drafts/draft-ietf-ldapbis-models-12.txt">MODELS</a>]
     * which is replicated here for convenience:
     * <pre>
     ...
     * MatchingRule Description Syntax 1.3.6.1.4.1.1466.115.121.1.30.  The
     * syntax is described in detail within section 4.1.3. of LDAPBIS
     * [<a href="http://ietf.org/internet-drafts/draft-ietf-ldapbis-models-12.txt">MODELS</a>]
     * which is replicated here for convenience:
     * <pre>
     ...
     * Description Syntax 1.3.6.1.4.1.1466.115.121.1.54.  The syntax is
     * described in detail within section 4.1.5. of LDAPBIS
     * [<a href="http://ietf.org/internet-drafts/draft-ietf-ldapbis-models-12.txt">MODELS</a>]
     * which is replicated here for convenience:
     * <pre>

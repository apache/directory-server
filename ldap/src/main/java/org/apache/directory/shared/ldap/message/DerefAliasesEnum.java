 ...
 * the value for the java.naming.ldap.derefAliases JNDI LDAP specific property.
 * 
    ...
    extends ValuedEnum
{
    ...
    public static final DerefAliasesEnum NEVERDEREFALIASES = 
        new DerefAliasesEnum( NEVERDEREFALIASES_NAME, NEVERDEREFALIASES_VAL ) ;
    /** Alias handling mode that dereferences only when searching */
    public static final DerefAliasesEnum DEREFINSEARCHING = 
        new DerefAliasesEnum( DEREFINSEARCHING_NAME, DEREFINSEARCHING_VAL ) ;
    /** Alias handling mode that dereferences only in finding the base */
    public static final DerefAliasesEnum DEREFFINDINGBASEOBJ = new 
        DerefAliasesEnum( DEREFFINDINGBASEOBJ_NAME, DEREFFINDINGBASEOBJ_VAL ) ;
    /** Alias handling mode that dereferences always */
    public static final DerefAliasesEnum DEREFALWAYS = 
        new DerefAliasesEnum( DEREFALWAYS_NAME, DEREFALWAYS_VAL ) ;
    ...
    public boolean derefInSearching()
    {
        switch( getValue() )
        {
            ...
            default:
                ...
                "Class has bug: check for valid enumeration values" ) ;
        }
    }
     ...
     * 
     * @param a_name the value for the java.naming.ldap.derefAliases or a name
     * of an enum value.
    ...
    public static DerefAliasesEnum getEnum( String a_name )
    {
        ...
        throw new IllegalArgumentException(
            "Unrecognized JNDI environment property " + JNDI_PROP 
            + " value: " + a_name ) ;
    }
     ...
     * environment.
     * 
     * @param env the JNDI environment with a potential value for the

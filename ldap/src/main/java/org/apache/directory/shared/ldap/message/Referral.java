 ...
 * constructed from a LDAPv3 URL parser.  The interface will eventually look
 * very different once url support is added: for one it will add and remove
 * LdapUrl objects instead of strings or provide both string and LdapUrl
 * add/remove methods.
 */

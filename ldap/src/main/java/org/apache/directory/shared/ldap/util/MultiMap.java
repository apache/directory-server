 ...
 * <p>
 * A <code>MultiMap</code> is a Map with slightly different semantics. Putting
 * a value into the map will add the value to a Collection at that key. Getting
 * a value will return a Collection, holding all the values put to that key.
 * <p>
 * For example:
 * 
 * <pre>
 ...
 * interface as they were defined in the superinterface <code>Map</code>
 * anyway.
 * 
...
public interface MultiMap extends Map
{
     ...
     * <code>null</code> from a subsequant <code>get(Object)</code>,
     ...
     * cannot be mandated due to backwards compatability of this interface.
     * 
     ...
     * <p>
     * The returned value will implement <code>Collection</code>.
     ...
     * been mapped to the key, however the implementation may choose to return
     * an empty collection.
     * <p>
     ...
     *         return <code>null</code> for no mapping, but may return an
     *         empty collection
     * @throws ClassCastException
     ...
     * value. This cannot be mandated due to backwards compatability of this
     * interface.
     * 
     * @param value

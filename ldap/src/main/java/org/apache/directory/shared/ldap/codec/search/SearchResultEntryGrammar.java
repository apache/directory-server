...
public class SearchResultEntryGrammar extends AbstractGrammar implements IGrammar
{
    ...
    private SearchResultEntryGrammar()
    {
        ...
        // ...
        // Nothing to do
        super.transitions[LdapStatesEnum.SEARCH_RESULT_ENTRY_OBJECT_NAME_TAG][UniversalTag.OCTET_STRING_TAG] = new GrammarTransition(
            LdapStatesEnum.SEARCH_RESULT_ENTRY_OBJECT_NAME_TAG, LdapStatesEnum.SEARCH_RESULT_ENTRY_OBJECT_NAME_VALUE,
            null );
        ...
        super.transitions[LdapStatesEnum.SEARCH_RESULT_ENTRY_OBJECT_NAME_VALUE][UniversalTag.OCTET_STRING_TAG] = new GrammarTransition(
        ...
        // ...
        // Nothing to do
        super.transitions[LdapStatesEnum.SEARCH_RESULT_ENTRY_ATTRIBUTES_TAG][UniversalTag.SEQUENCE_TAG] = new GrammarTransition(
            LdapStatesEnum.SEARCH_RESULT_ENTRY_ATTRIBUTES_TAG, LdapStatesEnum.SEARCH_RESULT_ENTRY_ATTRIBUTES_VALUE,
            null );
        ...
        super.transitions[LdapStatesEnum.SEARCH_RESULT_ENTRY_ATTRIBUTES_VALUE][UniversalTag.SEQUENCE_TAG] = new GrammarTransition(
            LdapStatesEnum.SEARCH_RESULT_ENTRY_ATTRIBUTES_VALUE,
            LdapStatesEnum.SEARCH_RESULT_ENTRY_PARTIAL_ATTRIBUTE_LIST_TAG, new GrammarAction( "Pop and end allowed" )
            {
                public void action( IAsn1Container container ) throws DecoderException
                {
        ...
        // ...
        // Nothing to do
        super.transitions[LdapStatesEnum.SEARCH_RESULT_ENTRY_PARTIAL_ATTRIBUTE_LIST_TAG][UniversalTag.SEQUENCE_TAG] = new GrammarTransition(
            LdapStatesEnum.SEARCH_RESULT_ENTRY_PARTIAL_ATTRIBUTE_LIST_TAG,
            LdapStatesEnum.SEARCH_RESULT_ENTRY_PARTIAL_ATTRIBUTE_LIST_VALUE, new GrammarAction( "Pop not allowed" )
            {
                public void action( IAsn1Container container ) throws DecoderException
                {
        ...
        // ...
        // Loop.
        super.transitions[LdapStatesEnum.SEARCH_RESULT_ENTRY_ATTRIBUTE_VALUE_OR_LIST_TAG][UniversalTag.SEQUENCE_TAG] = new GrammarTransition(
        ...
        // PartialAttributeList ::= SEQUENCE OF *SEQUENCE* { (Value)
        // ...
        // We may have many attributes. We also have to store a previously
        // decoded AttributeValue
        super.transitions[LdapStatesEnum.SEARCH_RESULT_ENTRY_PARTIAL_ATTRIBUTE_LIST_VALUE][UniversalTag.SEQUENCE_TAG] = new GrammarTransition(
        ...
        // ...
        // Nothing to do.
        super.transitions[LdapStatesEnum.SEARCH_RESULT_ENTRY_TYPE_TAG][UniversalTag.OCTET_STRING_TAG] = new GrammarTransition(
            LdapStatesEnum.SEARCH_RESULT_ENTRY_TYPE_TAG, LdapStatesEnum.SEARCH_RESULT_ENTRY_TYPE_VALUE, null );

        // PartialAttributeList ::= SEQUENCE OF SEQUENCE {
        // type AttributeDescription, (Value)
        // ...
        // Store the attribute's name.
        super.transitions[LdapStatesEnum.SEARCH_RESULT_ENTRY_TYPE_VALUE][UniversalTag.OCTET_STRING_TAG] = new GrammarTransition(
            LdapStatesEnum.SEARCH_RESULT_ENTRY_TYPE_VALUE, LdapStatesEnum.SEARCH_RESULT_ENTRY_VALS_TAG,
            new GrammarAction( "Store search result entry object name Value" )
            {
                public void action( IAsn1Container container ) throws DecoderException
                {
                    ...
                    else
                    {
                        ...
                        {
                            log
                                .error( "Invalid attribute type : {}", StringTools.dumpBytes( tlv.getValue().getData() ) );
        ...
        // Nothing to do
        super.transitions[LdapStatesEnum.SEARCH_RESULT_ENTRY_VALS_TAG][UniversalTag.SET_TAG] = new GrammarTransition(
            LdapStatesEnum.SEARCH_RESULT_ENTRY_VALS_TAG, LdapStatesEnum.SEARCH_RESULT_ENTRY_VALS_VALUE, null );

        // PartialAttributeList ::= SEQUENCE OF SEQUENCE {
        // ...
        // vals *SET OF* AttributeValue} (Value)
        // We may have many values. Nothing to do
        super.transitions[LdapStatesEnum.SEARCH_RESULT_ENTRY_VALS_VALUE][UniversalTag.SET_TAG] = new GrammarTransition(
            LdapStatesEnum.SEARCH_RESULT_ENTRY_VALS_VALUE,
            LdapStatesEnum.SEARCH_RESULT_ENTRY_ATTRIBUTE_VALUE_OR_LIST_TAG, new GrammarAction( "Pop and end allowed" )
            {
                public void action( IAsn1Container container ) throws DecoderException
                {
                    container.grammarPopAllowed( true );
        ...
        // vals SET OF *AttributeValue*} (Tag)
        // The loop.
        super.transitions[LdapStatesEnum.SEARCH_RESULT_ENTRY_ATTRIBUTE_VALUE_OR_LIST_TAG][UniversalTag.OCTET_STRING_TAG] = new GrammarTransition(
            LdapStatesEnum.SEARCH_RESULT_ENTRY_ATTRIBUTE_VALUE_OR_LIST_TAG,
        ...
        // ...
        // vals SET OF *AttributeValue*} (Value)
        // We may have many values. Store the current one in the current
        // Attribute Value
        super.transitions[LdapStatesEnum.SEARCH_RESULT_ENTRY_ATTRIBUTE_VALUE_VALUE][UniversalTag.OCTET_STRING_TAG] = new GrammarTransition(
            LdapStatesEnum.SEARCH_RESULT_ENTRY_ATTRIBUTE_VALUE_VALUE,
            LdapStatesEnum.SEARCH_RESULT_ENTRY_ATTRIBUTE_VALUE_OR_LIST_TAG, new GrammarAction(
                "Store Attribute Value value" )
            {
                public void action( IAsn1Container container )
                {

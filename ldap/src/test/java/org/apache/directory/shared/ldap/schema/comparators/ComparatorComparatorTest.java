...
/**
 * Test the Comparators comparator
 * 
...
{
    private ComparatorComparator comparator;
    
    @Before
    public void init()
    {
        comparator = new ComparatorComparator();
    }
    
    
    @Test
    public void testNullComparators()
    {
    ...
    @Test
    public void testEqualsComparators()
    {
    ...
    @Test
    public void testInvalidComparators()
    {
        String c1 = "( 1.1 FQCN org.apache.directory.SimpleComparator BYTECODE ABCDEFGHIJKLMNOPQRSTUVWXYZ+/abcdefghijklmnopqrstuvwxyz0123456789==== )";

...
public class DnParserTest extends TestCase
{
    ...
    public void testVsldapExtras() throws Exception
    {
        ...
        Assert.assertEquals(
            "cn=Billy Bakers,2.5.4.11=Corporate Tax,ou=Fin-Accounting,ou=Americas,ou=Search,o=IMC,c=US", name
                .toString() );
    }
    ...
    public final void testParseStringRFC2253_1() throws NamingException
    {
        ...
        assertEquals( "RFC2253_1 : ", "CN=Steve Kille,O=Isode limited,C=GB", nameRFC2253_1.toString() );
    }
    ...
    public final void testParseStringRFC2253_2() throws NamingException
    {
        ...
        assertEquals( "RFC2253_2 : ", "CN=Sales+CN=J. Smith,O=Widget Inc.,C=US", nameRFC2253_2.toString() );
    }
    ...
    public final void testParseStringRFC2253_5() throws NamingException
    {
        ...
        assertEquals( "RFC2253_5 : ", "1.3.6.1.4.1.1466.0=#04024869,O=Test,C=GB", nameRFC2253_5.toString() );
    }
    ...
    public final void testParseStringRFC2253_6() throws NamingException
    {
        ...
        assertEquals( "RFC2253_6 : ", "SN=Lu\\C4\\8Di\\C4\\87", nameRFC2253_6.toString() );
    }

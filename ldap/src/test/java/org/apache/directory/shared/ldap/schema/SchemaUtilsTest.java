...
public class SchemaUtilsTest extends TestCase
{
    public static Syntax[] getSyntaxes()
    {
        ...
        syntaxes[0] = new SyntaxImpl( "1.3.6.1.4.1.1466.115.121.1.12",
                "DN syntax", true );
        syntaxes[1] = new SyntaxImpl( "1.3.6.1.4.1.1466.115.121.1.15",
                "Directory String syntax", true );
        syntaxes[2] = new SyntaxImpl( "1.3.6.1.4.1.1466.115.121.1.58",
                "Substring assertion syntax", true );
        return syntaxes;
    }
    ...
    public AttributeType[] getAttributeTypes()
    {
        ...
        ats[0].setNames( new String[] { "name" } );
        ...
        ats[1].setNames( new String[] { "cn", "commonName" } );

        ats[2] = new AttributeTypeImpl( "2.5.4.41" );
        ats[2].setNames( new String[] { "name" } );
        ...
        ats[3].setNames( new String[] { "name" } );
        ...
        ats[4].setNames( new String[] { "name" } );
    ...
    public void testRenderQdescrs()
    {
        ...
        assertEquals( "", SchemaUtils.render( new String[] {} ).toString() ) ;
        assertEquals( "'name1'", SchemaUtils.render( new String[] { "name1" } ).toString() ) ;
        assertEquals( "( 'name1' 'name2' )", SchemaUtils.render( new String[] { "name1", "name2" } ).toString() ) ;
        assertEquals( "( 'name1' 'name2' 'name3' )", SchemaUtils.render( new String[] { "name1", "name2", "name3" } ).toString() ) ;
    ...
    static class MatchingRuleImpl extends AbstractMatchingRule
    {
        ...
        {
            throw new NotImplementedException( "getComparator in org.apache.ldap.common.schema.SchemaUtilsTest.MatchingRuleImpl not implemented!" );
        }


        public Normalizer getNormalizer() throws NamingException
        {
            throw new NotImplementedException( "getNormalizer in org.apache.ldap.common.schema.SchemaUtilsTest.MatchingRuleImpl not implemented!" );
        }
    }
}

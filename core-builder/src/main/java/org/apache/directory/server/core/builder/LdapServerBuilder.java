...
/**
 * A builder to create a working instance of LdapServer
 *
...
public class LdapServerBuilder
{
    ...
    public LdapServerBuilder() throws Exception
    {
    ...
    private void buildWorkingDirectory( String name )
    {
        ...
        {
            String path = LdapServerBuilder.class.getResource( "" ).getPath();
    ...
    /**
     * Build the server. We will create the DirectoryService, the transports,
     * 
     * TODO build.
     *
     * @param name
